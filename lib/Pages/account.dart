...
class _AccountPageState extends State<AccountPage> {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      //appbar
      appBar: AppBar(
        backgroundColor:const Color.fromARGB(255, 21, 91, 161),
        centerTitle: true,
            ...
            children:[
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Petunia Pet Park",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500),),
              ...
              Column(
                children: [
                  ...
                  ListTile(
                    leading: Icon(Icons.people_outline),onTap: (){},
